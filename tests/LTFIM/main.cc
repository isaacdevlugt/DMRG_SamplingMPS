...
int main() {
    ...
    DMRG_psi_path << "DMRG_psi_N=" << N << "_J=" << J << "_h=" << h << "_Omega=" << Omega << ends;
    ...
    sample_path_ << "MPS_sampling_algo_N=" << N << "_J=" << J << "_h=" << h << "_Omega=" << Omega << ends;
    sample_bases_path_ << "MPS_sampling_algo_bases_N=" << N << "_J=" << J << "_h=" << h << "_Omega=" << Omega << ends;
